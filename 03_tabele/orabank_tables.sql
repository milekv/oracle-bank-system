...
CREATE TABLE LOAN_INSTALLMENT (
    ...
    CONSTRAINT CK_INSTALLMENT_PAID CHECK (PAID_FLAG IN ('Y', 'N'))
);
...
CREATE TABLE BANK_TRANSACTION (
    ...
    CONSTRAINT FK_BANK_TX_ACCOUNT FOREIGN KEY (ACCOUNT_ID) REFERENCES ACCOUNT(ACCOUNT_ID),
    CONSTRAINT CK_BANK_TX_AMOUNT CHECK (AMOUNT <> 0)
);
...
CREATE TABLE TRANSFER (
    ...
    TITLE          VARCHAR2(200),
    CONSTRAINT FK_TRANSFER_TRANSACTION FOREIGN KEY (TRANSACTION_ID) REFERENCES BANK_TRANSACTION(TRANSACTION_ID)
);
